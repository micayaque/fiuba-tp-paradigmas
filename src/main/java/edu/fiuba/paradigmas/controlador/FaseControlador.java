...
import edu.fiuba.paradigmas.vista.victoria.PantallaVictoriaVista;
...
public abstract class FaseControlador {
    ...
    protected final JuegoControlador orquestador;
    ...
    public FaseControlador(JuegoControlador orquestador, Moderador moderador) {
