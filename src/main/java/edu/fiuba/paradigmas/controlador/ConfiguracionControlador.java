...
import edu.fiuba.paradigmas.vista.configuracion.CantidadJugadoresVista;
import edu.fiuba.paradigmas.vista.configuracion.NombresJugadoresVista;
import edu.fiuba.paradigmas.vista.configuracion.ConfiguracionRolesVista;
...
public class ConfiguracionControlador {
    ...
    private final JuegoControlador orquestador;
    private int cantidadJugadores;
    private List<String> nombresIngresados;

    public ConfiguracionControlador(JuegoControlador orquestador) {
