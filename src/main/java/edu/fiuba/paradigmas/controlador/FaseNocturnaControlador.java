...
public class FaseNocturnaControlador extends FaseControlador {
    ...
    public FaseNocturnaControlador(JuegoControlador orquestador, Moderador moderador) {
    ...
    private void mostrarPantallaDeAccion() {
        Jugador jugadorEnTurno = this.jugadoresVivos.get(this.indiceActual);
        TurnoNocturnoControlador turno = new TurnoNocturnoControlador(jugadorEnTurno, this.moderador, this);
    ...
    protected void finalizarFase() {
        ...
        ReporteFaseVista vistaPeriodico = new ReporteFaseVista("Edición Matutina ", titular, bajada, secciones, "COMENZAR DÍA");
