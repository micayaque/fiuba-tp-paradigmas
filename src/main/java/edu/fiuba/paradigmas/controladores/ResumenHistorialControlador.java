...
import edu.fiuba.paradigmas.vistas.victoria.ResumenHistorialVista;
...
public class ResumenHistorialControlador {
    ...
    public ResumenHistorialControlador(ControladorDeJuego orquestador, Moderador moderadorFinalizado) {
