...
import edu.fiuba.paradigmas.vistas.fase.diurna.DebateVista;
import edu.fiuba.paradigmas.vistas.fase.diurna.VotacionDiurnaVista;
...
public class FaseDiurnaControlador extends FaseControlador {
    ...
    public FaseDiurnaControlador(ControladorDeJuego orquestador, Moderador moderador) {
        super(orquestador, moderador);
        this.candidatosAVotar = new ArrayList<>(this.jugadoresVivos);
        this.mostrarPantallaDebate();
    }

    public FaseDiurnaControlador(ControladorDeJuego orquestador, Moderador moderador, List<Jugador> empatados) {
        super(orquestador, moderador);
