...
public class ComposicionMazoTest {
    ...
    public void con5Jugadores_1MafiosoYUnEspecialEsValido() {
        List<Rol> roles = new ArrayList<>(List.of(new Mafioso(), new Detective(),
                                  new Ciudadano(), new Ciudadano(), new Ciudadano()));
        assertDoesNotThrow(() -> new Mazo().generarPara(roles));
    }

    @Test
    public void con5Jugadores_2MafiososTambienEsValido() {
        List<Rol> roles = new ArrayList<>(List.of(new Mafioso(), new Mafioso(), new Detective(),
    ...
    public void con7Jugadores_2MafiososDetectiveYMedicoEsValido() {
        List<Rol> roles = new ArrayList<>(List.of(new Mafioso(), new Mafioso(), new Detective(), new Medico(),
                                  new Ciudadano(), new Ciudadano(), new Ciudadano()));
        assertDoesNotThrow(() -> new Mazo().generarPara(roles));
    }
    ...
    public void con10Jugadores_3DeMafiaConPadrinoYTodosLosEspecialesEsValido() {
        List<Rol> roles = new ArrayList<>(List.of(new Mafioso(), new Mafioso(), new Padrino(),
    ...
    public void laMafiaEnMayoriaEsRechazada() {              
        ...
        assertThrows(ComposicionInvalidaExcepcion.class, () -> new Mazo().generarPara(roles));
    }

    @Test
    public void demasiadosEspecialesParaPocosJugadoresEsRechazado() {
        List<Rol> roles = new ArrayList<>(List.of(new Mafioso(), new Detective(), new Medico(),
                                  new Ciudadano(), new Ciudadano()));
        assertThrows(ComposicionInvalidaExcepcion.class, () -> new Mazo().generarPara(roles));
    }
    ...
    public void dosDelMismoRolEspecialEsRechazado() {
        List<Rol> roles = new ArrayList<>(List.of(new Mafioso(), new Detective(), new Detective(),
                                  new Ciudadano(), new Ciudadano()));
        assertThrows(ComposicionInvalidaExcepcion.class, () -> new Mazo().generarPara(roles));
    }
    ...
    public void menosDe5JugadoresEsRechazado() {
        List<Rol> roles = new ArrayList<>(List.of(new Mafioso(), new Detective(), new Ciudadano(), new Ciudadano()));
        assertThrows(CantidadDeJugadoresInvalidaExcepcion.class, () -> new Mazo().generarPara(roles));
    }
}